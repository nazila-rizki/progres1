        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header">
              <h4 class="text-center mb-0"><i class="fas fa-pills"></i> Daftar Obat</h4>
            </div>
            ...
            <div class="card-body">
              <a href="<?= base_url('/ObatController/create') ?>" class="btn btn-success mb-3">
                <i class="fas fa-plus"></i> Tambah Data
              </a>

              <a href="<?= base_url('/ObatController/generatePdfReport') ?>" class="btn btn-danger mb-3">
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  <?php foreach ($obat as $data): ?>
                    <tr>
                      <td class="text-center"><?= htmlspecialchars($data['id_obat']) ?></td>
                      <td><?= htmlspecialchars($data['nm_obat']) ?></td>
                      <td class="text-center"><?= htmlspecialchars($data['kategori']) ?></td>
                      <td class="text-center"><?= htmlspecialchars($data['stok']) ?></td>
                      <td class="text-center"><?= htmlspecialchars(number_format($data['harga'], 0, ',', '.')) ?></td>
                      <td class="text-center">
                        <a href="<?= base_url('/ObatController/edit/' . $data['id_obat']) ?>" class="btn btn-warning btn-sm">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="<?= base_url('/ObatController/delete/' . $data['id_obat']) ?>" class="btn btn-danger btn-sm">
